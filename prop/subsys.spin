...
PUB StatusAmbient
  StatusOff
  modecog := cognew(SlowColorCycle, @stack) + 1 
}
PUB StatusActivity
  StatusOff
  SetColor($FF,$FF,$FF)
...
PRI SlowColorCycle
  ...
  FadeToColorBlocking(0,255,0,500)
  repeat
    FadeToColorBlocking(255,255,0,5000) ' yellow
    pause.delay_s(90)
    FadeToColorBlocking(255,0,0,5000)   ' red
    pause.delay_s(90)    
    FadeToColorBlocking(0,255,255,5000) ' magenta
    pause.delay_ms(90)
    FadeToColorBlocking(0,0,255,5000)   ' blue
    pause.delay_ms(90)
    FadeToColorBlocking(0,255,255,5000)   ' cyan
    pause.delay_ms(90)
    FadeToColorBlocking(0,255,0,5000)   ' green
    pause.delay_ms(90)
}
PUB uptime
  return long[RTCADDR]
